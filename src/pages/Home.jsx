        ...
        <div className={`rapp-main${inSession?" rapp-main-full":""}`}>
          ...
          {view==="library" && (showReturnCard
            ? <ReturnOnboardingCard
              ...
              />
            : <LibraryView cards={cards} decks={decks} deckMeta={deckMeta} onSelectDeck={d=>{setSelectedDeck(d);setView("deck")}} onCreateDeck={addDeck} syncStatus={syncStatus} lastSynced={lastSynced} settings={settings} onCreateSampleDeck={createSampleDeck} deckParentMap={deckParentMap} onArchiveDeck={archiveDeck} />
          )}
          {view==="deck"         && <DeckView deckName={selectedDeck} cards={cards} onUpdateCards={updateCards} onBack={()=>setView("library")} decks={decks} settings={settings} onArchiveDeck={archiveDeck} onDeleteDeck={deleteDeck} cardsLoading={!cardsFullyLoaded} deckMeta={deckMeta} />}
